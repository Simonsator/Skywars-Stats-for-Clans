 ...
 */
public class StatProviderSingle extends MSWStats {
	public StatProviderSingle(String pName, MSWStatsConnection pCon, Matcher pKillsMessage, Matcher pWinsMessage, Matcher pAssistsMessage, Matcher pDeathsMessage) {
